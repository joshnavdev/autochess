export const synergies = {
  ...
  demonhunter: {
    2: 'Negates an enemy demon’s power.',
    4: 'All friendly demons keep their power.',
    job: true,
    active: false,
  },
  druid: {
  ...
  hunter: {
    ...
    9: 'All friendly hunters have additional +40 base attack damage and +40% chance to pierce through evasion.',
    job: true,
    active: false,
  },
  knight: {
    2: 'All friendly Knights have a 40% chance to proc a damage-reducing shield.',
  ...
  mech: {
    3: 'HP regeneration increased by 15 for all friendly mechs.',
    6: 'HP regeneration increased by an additional 25 for all friendly mechs.',
    job: true,
    active: false,
  },
  shaman: {
    2: 'Hex a random enemy when battle starts for 8 seconds.',
    4: 'Hex a random enemy when battle starts for 8 seconds.',
    6: 'Hex a random enemy when battle starts for 8 seconds.',
    job: true,
    active: false,
  },
  warlock: {
    2: 'Provides 10% lifesteal and 10% spell lifesteal to all allies.',
    4: 'Provides 10% lifesteal and 10% spell lifesteal to all allies.',
  ...
  human: {
    3: 'All friendly humans have a 20% chance to silence the target for 4s when 9ttacking.',
    6: 'All friendly humans have an additional 25% chance to silence the target for 4s when attacking.',
    race: true,
    active: false,
  },
  naga: {
    ...
    6: 'Magic resistance increased by an additional 30% for all allies.',
    race: true,
    active: false,
  },
  ogre: {
    2: 'Grant +5% max HP for all allies',
    race: true,
    active: false,
  },
  orc: {
  ...
  troll: {
    ...
    6: 'Attack speed increased by 30% for all allies.',
    race: true,
    active: false,
  },
  undead: {
    3: 'Armor decreased by 4 for all enemies.',
    6: 'Armor decreased by 6 for all enemies.',
    9: 'Armor decreased by 7 for all enemies.',
    race: true,
    active: false,
  },
  god: {
    2: 'All allies cd decreased by 50%',
    4: 'All allies cd decreased by 50% more (75%)',
    6: 'All allies cd decreased by 50% more (75%)',
    race: true,
    active: false,
  },
  priest: {
    2: 'Reduce damage to courier by 20%.',
    4: 'Reduce damage to courier by 20%.',
    job: true,
    active: false,
  },
  satyr: {
